                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="relative z-10">
                            ...
                            <FancyRectangle colour="white" offset="8" filled={false}>
                                <div className="flex items-center gap-4 bg-white px-6 py-3 shadow-lg">
                                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white md:h-20 md:w-20">
                                        <Image
                                    ...
                                    <span className="text-3xl font-black text-grey md:text-4xl lg:text-5xl">
                                        CODEC
                                    </span>
                                </div>
                            </FancyRectangle>
